            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="time" type="datetime-local"
                           ...
                           value="{{ $tournament->time->format('Y-m-d\TH:i') }}"
                           required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="application_deadline" type="datetime-local"
                           ...
                           value="{{ $tournament->application_deadline->format('Y-m-d\TH:i') }}"
                           required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <span class="text-danger" role="alert">
                        <strong>Uploading new sponsor logos will delete previous ones</strong>
                    </span>
                </div>
            </div>
